...
EntityPlayer = ig.Entity.extend({
	...
	update: function() {
		...
		if( ig.input.state('left') && ig.game.newScene == false && ig.game.drawingScene == false) {
			this.accel.x = -accel;
			this.flip = true;
		}
		else if( ig.input.state('right') && ig.game.newScene == false && ig.game.drawingScene == false) {
			this.accel.x = accel;
			this.flip = false;
		}
		else if(ig.input.state('attack') && ig.game.newScene == false && ig.game.drawingScene == false) {
